  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="bg-card rounded-lg shadow-sm p-6 sm:p-8 lg:p-12">
          <h1 className="text-3xl font-bold text-foreground mb-8 font-display">Datenschutzerklärung</h1>

          <div className="prose prose-lg max-w-none text-secondary-foreground space-y-8 font-body">

            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4 font-display">1. Allgemeine Informationen zur Erhebung und Verarbeitung von Daten</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4 font-display">2. Rechtsgrundlagen für die Verarbeitung von personenbezogenen Daten</h2>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">a) Formulare auf unserer Webseite</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">b) Übermittlung von Daten zwecks Lead-Qualifizierung</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">c) Verarbeitung von Daten bei Buchen einer Leistung bei uns; Beratungsanfrage per Telefon oder Live-Chat</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">d) HINWEIS zu Ihren Rechten und der Löschung Ihrer Daten:</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4 font-display">3. Verarbeitung von Daten mittels Cookies und Pixeln; Ihr Widerspruchsrecht</h2>

              <h3 className="text-xl font-semibold text-foreground mb-3 font-display">a) Was sind Cookies und Pixel?</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">b) Kann ich Cookies und Pixel verhindern?</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">c) Cookies und Pixel auf unseren Webseiten: Einsatzzweck, Rechtsgrundlage, Empfänger Ihrer Daten</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">d) Widerspruchsrecht gegen die Analyse der Nutzung der Webseite durch Sie</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4 font-display">4. Verarbeitung von Daten mittels Logfiles</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4 font-display">8. Ihre Rechte</h2>

              <h3 className="text-xl font-semibold text-foreground mb-3 font-display">a) Rechte als betroffene Person</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">b) Insbesondere: Ihr Widerspruchsrecht</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">c) Kontaktadresse für Ausübung Ihrer Rechte</h3>
              <p>
                Jegliche Ersuchen zu Ihren personenbezogenen Daten richten Sie bitte an: <a href="mailto:matthias.frank@deinvergleich.com" className="text-primary hover:text-primary/80">matthias.frank@deinvergleich.com</a>
              </p>

              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6 font-display">d) Beschwerderecht bei der Aufsichtsbehörde</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4 font-display">9. Dauer der Speicherung und routinemäßige Löschung</h2>
              <p className="mb-4">
            ...
            <div className="mt-12 pt-8 border-t border-border">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Bei Fragen zur Verarbeitung Ihrer personenbezogenen Daten kontaktieren Sie uns gerne unter: <a href="mailto:matthias.frank@deinvergleich.com" className="text-primary hover:text-primary/80">matthias.frank@deinvergleich.com</a>
              </p>
            </div>
          </div>
        </div>
